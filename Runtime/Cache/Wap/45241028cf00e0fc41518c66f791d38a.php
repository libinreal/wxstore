    ...
    <div class="wrapper">
        <div id="login-panel" class="panel" data-tab="normal">
            <div id="normal-panel" class="active-panel normal-panel">
                <form id="normal-login-form" action="<?php echo U('Store/register');?>" autocomplete="off" method="post">
...
<p class="sub-action"><a href="<?php echo U('Store/login');?>">已有账号，现在登录</a> <!-- <a href="">找回密码</a> --></p>
